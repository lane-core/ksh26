...
[[nodiscard]] extern void *sh_malloc(size_t size);
[[nodiscard]] extern void *sh_realloc(void *ptr, size_t size);
[[nodiscard]] extern void *sh_calloc(size_t nmemb, size_t size);
[[nodiscard]] extern char *sh_strdup(const char *s);
[[nodiscard]] extern void *sh_memdup(const void *s, size_t n);
