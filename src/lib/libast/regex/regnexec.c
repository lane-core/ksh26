...
#define follow(e, r, c, s) ((r)->next ? parse(e, (r)->next, c, s) : (c) ? parse(e, c, 0, s) \
	                                                                : BEST)
...
int regnexec_20120528(const regex_t *p, const char *s, size_t len, size_t nmatch, regmatch_t *match, regflags_t flags)
{
	ssize_t n = 0;
	int i;
	int j;
