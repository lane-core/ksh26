# probe: ast-api — API version mapping (pure text, no C compilation)
# Tier 1. Emits AST_VERSION, ASTAPI macro, and versioned function renames.
#
# Lifted from monolith probe_ast_api with output path from $1.
...
probe_ast_api()
{
	...
	if [ "$opt_force" = 0 ] && [ -f "$_out" ] \
	   && [ "$_out" -nt "$LIBAST_SRC/features/api" ]; then
		return 0
	fi

	# Pure text generation — the api probe has no C compilation.
	{
		cat <<'HEADER'
/* : : generated by configure.sh probe_ast_api : : */
#ifndef _AST_API_H
#define _AST_API_H	1
#define _sys_types	1	/* #include <sys/types.h> ok */
#define _AST_VERSION AST_VERSION /* pre-20100601 compatibility */

#define AST_VERSION	20250410
...
#define _API_ast_MAP	"cmdopen_20120411 cmdopen_20110505 pathaccess_20100601 pathcanon_20100601 pathcat_20100601 pathpath_20100601 pathrepl_20100601 regexec_20120528 regnexec_20120528 regsubexec_20120528 sfkeyprintf_20000308"
